				...
				<div class="login-form bg-light mt-4 p-4">
					...
					<form action="car" method="post" class="row g-3">
						...
						<c:if test="${ not empty success and success }">
							<p class="text-success">Car is updated</p>
						</c:if>

						<c:if test="${ not empty success and not success }">
							<p class="text-danger">
								Something went wrong.<br>Fail to update the car!
							</p>
						</c:if>
						

						<input type="hidden" name="mode" value="UPDATE"> <input
							type="hidden" name="id" value="${ car.id }">
						...
						<div class="col-12">
							...
							<div class="input-group">
								<span class="input-group-text"> N </span> <input type="text"
									value="${car.name }" name="name" class="form-control"
						...
						<div class="col-12">
							...
							<div class="input-group">
								<span class="input-group-text"> B </span> <input type="text"
									value="${car.brand }" name="brand" class="form-control"
						...
						<div class="col-12">
							...
							<div class="input-group">
								<span class="input-group-text"> M </span> <input type="text"
									value="${car.model }" name="model" class="form-control"
						...
						<div class="col-12">
							...
							<div class="input-group">
								<span class="input-group-text"> $ </span> <input type="text"
									value="${car.price }" name="price" class="form-control"
						...
						<div class="col-12">
							...
							<div class="input-group">
								<span class="input-group-text"> Mi </span> <input type="number"
									value="${car.mileage }" name="mileage" class="form-control"
						...
						<div class="col-12">
							...
							<div class="input-group">
								<span class="input-group-text"> E </span> <input type="text"
									value="${car.engine }" name="engine" class="form-control"
						...
						<div class="col-12">
							...
							<div class="input-group">
								<span class="input-group-text"> Hp </span> <input type="number"
									value="${car.horsepower }" name="horsepower" class="form-control"
						...
						<div class="col-12">
							...
							<div class="input-group">
								<span class="input-group-text"> Li </span> <input type="text"
									value="${car.license }" name="license" class="form-control"
						...
						<div class="col-12">
							...
							<div class="input-group">
								<span class="input-group-text"> <i class="bi bi-image"></i> </span> <input type="url"
									value="${images.front }" name="front" class="form-control"
						...
						<div class="col-12">
							...
							<div class="input-group">
								<span class="input-group-text"> <i class="bi bi-image"></i> </span> <input type="url"
									value="${images.back }" name="back" class="form-control"
									placeholder="image url" required="required">
							</div>
						</div>
						...
						<div class="col-12">
							...
							<div class="input-group">
								<span class="input-group-text"> <i class="bi bi-image"></i> </span> <input type="url"
									value="${images.left }" name="left" class="form-control"
									placeholder="image url" required="required">
							</div>
						</div>
						...
						<div class="col-12">
							...
							<div class="input-group">
								<span class="input-group-text"> <i class="bi bi-image"></i> </span> <input type="url"
									value="${images.right }" name="right" class="form-control"
									placeholder="image url" required="required">
							</div>
						</div>
						...
						<div class="col-12">
							...
							<div class="input-group">
								<span class="input-group-text"> <i class="bi bi-image"></i> </span> <input type="url"
									value="${images.front_interior }" name="frontinterior" class="form-control"
									placeholder="image url" required="required">
							</div>
						</div>
						...
						<div class="col-12">
							...
							<div class="input-group">
								<span class="input-group-text"> <i class="bi bi-image"></i> </span> <input type="url"
									value="${images.back_interior }" name="backinterior" class="form-control"
									placeholder="image url" required="required">
							</div>
						</div>
						...
						<div class="col-12">
							...
							<div class="input-group">
								<span class="input-group-text"> <i class="bi bi-image"></i> </span> <input type="url"
									value="${images.engine }" name="engineimage" class="form-control"
									placeholder="image url" required="required">
							</div>
						</div>
